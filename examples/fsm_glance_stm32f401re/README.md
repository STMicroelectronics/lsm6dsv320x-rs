# LSM6DSV320X Sensor Data Acquisition on STM32F401RE with IKS4A1 Shield (UCF-Configured FSM Events)
...
- The sensor is configured by applying a sequence of register writes and delays generated by the **`ucf-tool`** from a UCF file (`lsm6dsv320x_glance_detection.ucf`), which programs the sensor's FSM for gesture detection.
