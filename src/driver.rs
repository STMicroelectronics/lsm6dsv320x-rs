...
/// Driver for the LSM6DSV320X sensor.
///
...
#[bisync]
impl<P, T> Lsm6dsv320x<i2c::I2cBus<P>, T, MainBank>
where
    P: I2c,
    T: DelayNs,
{
...
#[bisync]
impl<P, T> Lsm6dsv320x<spi::SpiBus<P>, T, MainBank>
where
    P: SpiDevice,
    T: DelayNs,
{
...
#[bisync]
impl<B: BusOperation, T: DelayNs, S: BankState> MemBankFunctions<MemBank> for Lsm6dsv320x<B, T, S> {
...
#[bisync]
impl<B: BusOperation, T: DelayNs> EmbAdvFunctions for Lsm6dsv320x<B, T, MainBank> {
    type Error = Error<B::Error>;
...
#[bisync]
impl<B: BusOperation, T: DelayNs, S: BankState> SensorOperation for Lsm6dsv320x<B, T, S> {
    type Error = Error<B::Error>;
...
#[bisync]
impl<B: BusOperation, T: DelayNs> Lsm6dsv320x<B, T, MainBank> {
...
pub fn from_fs320_to_mg(lsb: i16) -> f32 {
    (lsb as f32) * 10.417
}
